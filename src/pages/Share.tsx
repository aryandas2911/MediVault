    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F0F4FF] to-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="card bg-gradient-to-r from-blue-50 to-blue-100/50 border border-blue-200">
                ...
                >
                    ...
                    <motion.div
                      ...
                      animate={{
                        boxShadow: [
                          ...
                          "0 0 0 10px rgba(26, 115, 232, 0.1)",
                          "0 0 0 0 rgba(26, 115, 232, 0)"
                        ]
                      }}
                      transition={{
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg mb-4">
                    ...
                    <motion.button
                      ...
                      className="text-primary hover:text-primary/90 p-2 rounded-lg hover:bg-white transition-colors"
